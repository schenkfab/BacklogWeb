    ...
    <li class="p-2 mb-3 bg-white shadow rounded-lg cursor-move" style="min-width: 300px;">
        <div class="flex justify-between items-center">
          <div class="flex items-center">
            <img class="w-8 h-8 rounded-full" v-if="data.picture" :src="data.picture" :alt="data.name">
            ...
            <p class="ml-2 text-gray-700 font-sans tracking-wide text-sm text-left">{{data.name}}</p>
          </div>
          <div class="flex">
