<template>
  <nav class="flex items-center justify-between flex-wrap pl-4">
    <div class="flex items-center flex-shrink-0 mr-6">
      <svg class="h-8 fill-current inline" id="icon-bar-chart" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="#2a2a31" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
      ...
      <span class="font-semibold text-3xl tracking-tight pl-4 bg-nav">Backlog</span>
    </div>
    <div class="w-full block flex-grow lg:flex lg:items-center lg:w-auto pt-1">
      <div class="lg:flex-grow">
        ...
        <a class="block lg:inline-block hoverable hover:bg-pink-500 hover:text-white p-5" v-if="this.getUser.initialized">
          <a href="#" class="relative font-bold hover:bg-pink-500 hover:text-white">Boards</a>
            <div class="mega-menu mb-16 sm:mb-0 shadow-xl p-6 mt-5">
              <div class="container mx-auto w-full flex flex-wrap justify-between mx-2">
                <div class="w-full text-white mb-8">
                  <h2 class="font-bold text-2xl">Boards</h2>
                  <p>Each collection you follow, will be a board with the appropriate actions.</p>
                </div>
                <ul class="px-4 w-full sm:w-1/2 lg:w-1/2 border-gray-600 border-b sm:border-r lg:border-b-0 pb-6 pt-6 lg:pt-3">
                  <div class="flex items-center">
                    ...
                    <h3 class="font-bold text-xl text-white text-bold mb-2">Private Boards</h3>
                  </div>
                  <div class="inline-block items-center py-1" >
                    <div class="flex items-center py-1" v-for="follow in this.getFollows.filter(o => o.collection.isPrivate)" v-bind:key="follow.id">
                      <router-link
                        class="text-white bold border-b-2 border-purple-300 hover:text-purple-300 text-xs"
                        :to='`/board/${follow.id}`'
                      >{{ getCollectionName(follow.collection.id) }}</router-link>
                    </div>
                  </div>
                </ul>
                <ul class="px-4 w-full sm:w-1/2 lg:w-1/2 border-gray-600 border-b sm:border-r-0 lg:border-r lg:border-b-0 pb-6 pt-6 lg:pt-3">
                  <div class="flex items-center">
                    <svg class="h-8 mb-3 mr-3 fill-current text-white"
                      xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                      <path d="M14.613,10c0,0.23-0.188,0.419-0.419,0.419H10.42v3.774c0,0.23-0.189,0.42-0.42,0.42s-0.419-0.189-0.419-0.42v-3.774H5.806c-0.23,0-0.419-0.189-0.419-0.419s0.189-0.419,0.419-0.419h3.775V5.806c0-0.23,0.189-0.419,0.419-0.419s0.42,0.189,0.42,0.419v3.775h3.774C14.425,9.581,14.613,9.77,14.613,10 M17.969,10c0,4.401-3.567,7.969-7.969,7.969c-4.402,0-7.969-3.567-7.969-7.969c0-4.402,3.567-7.969,7.969-7.969C14.401,2.031,17.969,5.598,17.969,10 M17.13,10c0-3.932-3.198-7.13-7.13-7.13S2.87,6.068,2.87,10c0,3.933,3.198,7.13,7.13,7.13S17.13,13.933,17.13,10"></path>
                    </svg>
                    <h3 class="font-bold text-xl text-white text-bold mb-2">Public Boards</h3>
                  </div>
                  <div class="inline-block items-center py-1" >
                    <div class="flex items-center py-1" v-for="follow in this.getFollows.filter(o => !o.collection.isPrivate)" v-bind:key="follow.id">
                      <router-link
              ...
              <div class="container mx-auto w-full flex flex-wrap justify-between mx-2">
                ...
                <ul class="px-4 w-full sm:w-1/2 lg:w-1/4 border-gray-600 border-b sm:border-r lg:border-b-0 pb-6 pt-6 lg:pt-3">
                  <div class="flex items-center">
                    ...
                    <h3 class="font-bold text-xl text-white text-bold mb-2">List of Feeds</h3>
                  </div>
                  <p class="text-gray-100 text-sm">See all feeds that have already been added by you or someone else. Add those feeds to one of your collections!</p>
                ...
                <ul class="px-4 w-full sm:w-1/2 lg:w-1/4 border-gray-600 border-b sm:border-r-0 lg:border-r lg:border-b-0 pb-6 pt-6 lg:pt-3">
                  <div class="flex items-center">
                    ...
                    <h3 class="font-bold text-xl text-white text-bold mb-2">Add YouTube Channel</h3>
                  </div>
                  <p class="text-gray-100 text-sm">Have all your YouTube channels and RSS feeds in one place by also adding your favorite YouTube channels.</p>
                  <div class="flex items-center py-3">
                    <svg class="h-6 pr-3 fill-current text-purple-300"
                      xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                      <path d="M20 10a10 10 0 1 1-20 0 10 10 0 0 1 20 0zm-2 0a8 8 0 1 0-16 0 8 8 0 0 0 16 0zm-8 2H5V8h5V5l5 5-5 5v-3z"/>
                ...
                <ul class="px-4 w-full sm:w-1/2 lg:w-1/4 border-gray-600 border-b sm:border-b-0 sm:border-r md:border-b-0 pb-6 pt-6 lg:pt-3">
                  <div class="flex items-center">
                    ...
                    <h3 class="font-bold text-xl text-white text-bold mb-2">Add RSS Feed</h3>
                  </div>
                  <p class="text-gray-100 text-sm">Add a new RSS feed to the system.</p>
                  <div class="flex items-center py-3">
                    <svg class="h-6 pr-3 fill-current text-purple-300"
                      xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                      <path d="M20 10a10 10 0 1 1-20 0 10 10 0 0 1 20 0zm-2 0a8 8 0 1 0-16 0 8 8 0 0 0 16 0zm-8 2H5V8h5V5l5 5-5 5v-3z"/>
            ...
            <div class="mega-menu mb-16 sm:mb-0 shadow-xl p-6 mt-5">
              <div class="container mx-auto w-full flex flex-wrap justify-between mx-2">
                <div class="w-full text-white mb-8">
                  ...
                  <p>A collection is a combination of feeds. Structure your feeds in collections or follow already created collections!</p>
                </div>
                <ul class="px-4 w-full sm:w-1/2 lg:w-1/3 border-gray-600 border-b sm:border-r lg:border-b-0 pb-6 pt-6 lg:pt-3">
                  <div class="flex items-center">
                    ...
                    <h3 class="font-bold text-xl text-white text-bold mb-2">My Collections</h3>
                  </div>
                  <p class="text-gray-100 text-sm">See all collections you have created or you follow.</p>
                  <div class="flex items-center py-3">
                    <svg class="h-6 pr-3 fill-current text-purple-300"
                      xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                      <path d="M20 10a10 10 0 1 1-20 0 10 10 0 0 1 20 0zm-2 0a8 8 0 1 0-16 0 8 8 0 0 0 16 0zm-8 2H5V8h5V5l5 5-5 5v-3z"/>
                ...
                <ul class="px-4 w-full sm:w-1/2 lg:w-1/3 border-gray-600 border-b sm:border-r-0 lg:border-r lg:border-b-0 pb-6 pt-6 lg:pt-3">
                  <div class="flex items-center">
                    ...
                    <h3 class="font-bold text-xl text-white text-bold mb-2">Top Collections</h3>
                  </div>
                  <p class="text-gray-100 text-sm">All collections ordered by the amount of followers.</p>
                  <div class="flex items-center py-3">
                    <svg class="h-6 pr-3 fill-current text-purple-300"
                      xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                      <path d="M20 10a10 10 0 1 1-20 0 10 10 0 0 1 20 0zm-2 0a8 8 0 1 0-16 0 8 8 0 0 0 16 0zm-8 2H5V8h5V5l5 5-5 5v-3z"/>
                ...
                <ul class="px-4 w-full sm:w-1/2 lg:w-1/3 border-gray-600 border-b sm:border-b-0 sm:border-r md:border-b-0 pb-6 pt-6 lg:pt-3">
                  <div class="flex items-center">
                    ...
                    <h3 class="font-bold text-xl text-white text-bold mb-2">Add Collection</h3>
                  </div>
                  <p class="text-gray-100 text-sm">Create a new public or private collection.</p>
                  <div class="flex items-center py-3">
                    <svg class="h-6 pr-3 fill-current text-purple-300"
                      xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                      <path d="M20 10a10 10 0 1 1-20 0 10 10 0 0 1 20 0zm-2 0a8 8 0 1 0-16 0 8 8 0 0 0 16 0zm-8 2H5V8h5V5l5 5-5 5v-3z"/>
      ...
      <div>
        ...
        ><img
          ...
          class="h-8 w-8 rounded-lg border-solid border-2 border-green-600 mr-2 text-sm font-bold font-sans"
